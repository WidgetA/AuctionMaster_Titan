...
--[[
	A mix of Ace3 TreeGroup and blizzard's DropDownMenu.
--]]
...
do
	...
	local function Constructor()
		...
		self.title = title
		title:SetPoint("BOTTOMLEFT", frame, "TOPLEFT", 5, 0)
		...
		local scrollbar = CreateFrame("Slider", ("AucMasTreeMenu%dScrollBar"):format(createdcount), treeframe, "UIPanelScrollBarTemplate")
